...
\begin{itemize}
    ...
    \item Introduce the 6-term model here. It allows you to understand things like leakage, resistance, and dielectric absorption. We care about the resistive losses over frequency.
    \item Talk about the difference between a functional model (Maruata's) and a model that allows you to understand what is going on inside of a capacitor (6-term).
