...
\subsubsection{RLC}
The RLC model, shown in Figue: \ref{fig:rlcModel}, is one of the simplest models used to describe a capacitor. It shows the basic high and low frequency characteristics, along with the capacitor's resonant point.
