...
The second problem is that this technique is heavily biased by high frequency data. As can be seen in Figure: \ref{fig:levy}, a applying Levy's technique with $3^{rd}$ order model provides an unuseable fit to the emperical data.
